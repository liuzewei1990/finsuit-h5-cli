...
export default new Vuex.Store({
    state: {
        ...
        // 站外APP_FLAG
        FROM_APP_FLAG: sessionStorage.getItem("FROM_APP_FLAG") || "BC",// 来源FROM_APP_FLAG适用站外适用  PC(拼财) || BC(比财) || PMP(小程序)

        ACTITY_ID: sessionStorage.getItem("ACTITY_ID") || "",       // 活动id
    },
    getters: {
        isLogin: state => {
    ...
    mutations: {
        ...
        ["ACTITY_ID"] (state, params) {
            ...
            sessionStorage.setItem("ACTITY_ID", String(params.ACTITY_ID || ""));
        }
    },
    modules: {},
