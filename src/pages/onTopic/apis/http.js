...
import Toast from '@onTopic/components/Toast'
...
axios.interceptors.response.use(function (response) {
    ...
    if (!(response.status === 200 || response.status === 201)) {
        httpErrorDialog("http statusCode error");
    ...
    if (Object.prototype.toString.call(responseData) !== "[object Object]") {
        httpErrorDialog("responseData not Object");
    ...
    httpErrorDialog(responseData.head.MSG);
...
export default {
    ...
    post: function (baseURL, url, urlType, paramData = {}, paramHead = {}, isLoading = false, isGetCode = false) {
        ...
        param_key["head"] = {
            ...
            SYSTEM_TYPE: sessionStorage.getItem("SYSTEM_TYPE") || (browser.OS + "").toUpperCase(),
            APP_FLAG: sessionStorage.getItem("APP_FLAG") || sessionStorage.getItem("FROM_APP_FLAG") || "BC",
    ...
    postPoint: function (baseURL, url, params = {}) {
        ...
        param_key["param"] = {
            FUNCTION_LOG_LIST: [{
                FROM_ID: sessionStorage.getItem("ACTITY_ID"),          // 获取活动id
                APP_PLACE: 98,                                         // 日志位置
                FROM_TYPE: 15,                                         // 日志分类
